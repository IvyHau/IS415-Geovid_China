...
![Main tabs](figures/ui/main-tab-bar.jpg)\
\begin{center}
Figure 3: Main Tabs Design
\end{center}
...
![EDA Sub-tabs Design](figures/ui/eda-tabs.jpg)\
\begin{center}
Figure 4: EDA Sub-tabs Design
\end{center}
![EDA Line Graph User Interface Design](figures/ui/eda-page-ui-line.jpg)\
\begin{center}
Figure 5: EDA Line Graph User Interface Design
\end{center}
![EDA Choropleth User Interface Design](figures/ui/eda-page-ui-choropleth.jpg)\
\begin{center}
Figure 6: EDA Choropleth User Interface Design
\end{center}
![EDA Box Map User Interface Design](figures/ui/eda-page-ui-boxmap.jpg)\
\begin{center}
Figure 7: EDA Box Map User Interface Design
\end{center}
...
![Spatial Autocorrelation Sub-tabs Design](figures/ui/saa-tabs.jpg)\
\begin{center}
Figure 8: Spatial Autocorrelation Sub-tabs Design
\end{center}
![Local Moran's I User Interface Design](figures/ui/spatial_autocorrelation_page_local_moran_i-ui.jpg)\
\begin{center}
Figure 9: Local Moran's I User Interface Design
\end{center}
![LISA User Interface Design](figures/ui/spatial_autocorrelation_page_lisa-ui.jpg)\
\begin{center}
Figure 10: LISA User Interface Design
\end{center}
![Global Moran's I User Interface Design](figures/ui/Moran_I_Scatterplot_app_interface.jpg)\
\begin{center}
Figure 11: Global Moran's I User Interface Design
\end{center}
...
\begin{center}
Figure 12: Data Outlook User Interface Design
\end{center}
...
\begin{center}
Figure 14: Spatial Autocorrelation User Input
\end{center}
...
\begin{center}
Figure 15: Line Graph of Confirmed Cases
\end{center}
...
\begin{center}
Figure 16: Choropleth of Confirmed Cases
\end{center}
...
\begin{center}
Figure 17: Box Map of Confirmed Cases
\end{center}
...
\begin{center}
Figure 18: Line Graph of Recovered Cases
\end{center}
...
\begin{center}
Figure 19: Choropleth of Recovered Cases
\end{center}
...
\begin{center}
Figure 20: Box Map of Recovered Cases
\end{center}
...
Based on Figure [21] below, it can be seen that it started off with 253 death cases in January, and followed by a spike of 2526 new death cases in February. 
...
\begin{center}
Figure 21: Line Graph of Death Cases
\end{center}
...
\begin{center}
Figure 22: Choropleth of Death Cases
\end{center}
...
To determine if clusters observed in the earlier choropleth is significant, local Moran I is used to compute the relationship between each region to its neighbour. The figure [23] below shows the Local Moran's I of each respective type of cases based on the adaptive weight matrix. 
...
\begin{center}
Figure 23: Local Moran's I for Confirmed Cases
\end{center}

Moving forward, the figure [24] below shows the recovered cases in Wuhan having a positive local Moran I statistics, which imply that there is enough evidence to conclude that Wuhan is a spatial cluster. This also suggest that recovered COVID-19 cases in Wuhan highly affects the number of recovered cases in its neighbouring areas.
...
\begin{center}
Figure 24: Local Moran's I for Confirmed Cases
\end{center}

As observed from Figure [25], the death rate in Wuhan shows a significant evidence of spatial cluster, suggesting that its death rate will greatly affect its neighbouring areas. The negative Local Moran's I areas implies that the death rate in the area will not greatly affect the death rate in its neighbouring areas. 

![Local Moran's I for Death Cases](figures/correlation/local_moran_i_death-adaptive.jpg)\
\begin{center}
Figure 25: Local Moran's I for Confirmed Cases
\end{center}


### Global Moran's I

![Global Moran's I for Confirmed Cases](figures/correlation/scatterplot_confirmed_rook_binary.jpg)\
\begin{center}
Figure 26: Global Moran's I for Confirmed Cases
\end{center}

![Global Moran's I for Recovered Cases](figures/correlation/)\
\begin{center}
Figure 27: Global Moran's I for Recovered Cases
\end{center}

![Global Moran's I for Death Cases](figures/correlation/)\
\begin{center}
Figure 28: Global Moran's I for Death Cases
\end{center}
...
![LISA for Confirmed Cases](figures/correlation/lisa_confirmed_adaptive.jpg)\
\begin{center}
Figure 29: LISA for Confirmed Cases
\end{center}

![LISA for Recovered Cases](figures/correlation/lisa recovered.jpg)\
\begin{center}
Figure 30: LISA for Recovered Cases
\end{center}

![LISA for Death Cases](figures/correlation/lisa death.jpg)\
\begin{center}
Figure 31: LISA for Death Cases
\end{center}
